      ...
      <>
        ...
        <div id={numChristoffelCalculated} className='result' ref={resultRef}>
          ...
          <div
            ...
            <ExportToLatex result={christoffel_sk} name="christoffel_sk" />
            ...
            <div>
              ...
              <ExportToLatex result={christoffel_fk} name="christoffel_fk" />
              <div className='resultMathJax'>
              ...
              submittedValues.onlyCS === 'option_2'
                ...
                <>
                  <div>
                    ...
                    <ExportToLatex result={riemann_tensor} name="riemann_tensor" />
                    <div className='resultMathJax'>
                  ...
                  <div>
                    ...
                    <ExportToLatex result={ricci_tensor} name="ricci_tensor" />
                    <div className='resultMathJax'>
                      <div style={{
                        display: 'flex',
                        gap: '0.2rem',
                  ...
                  <div style={{
                    ...
                    <ExportToLatex result={ricci_scalar} name="ricci_scalar" />
                    <div className='resultMathJax'>
                      <div style={{
                        display: 'flex',
                        gap: '0.2rem',
                  ...
                  <div>
                    ...
                    <ExportToLatex result={einstein_tensor} name="einstein_tensor" />
                    <div className='resultMathJax'>
                      <div style={{
                        display: 'flex',
                        gap: '0.2rem',
